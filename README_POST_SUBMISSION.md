...
[![PyPI version](https://img.shields.io/pypi/v/grouprec.svg)](https://pypi.org/project/grouprec/)
[![Python versions](https://img.shields.io/pypi/pyversions/grouprec.svg)](https://pypi.org/project/grouprec/)
[![License: MIT](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE)
[![Downloads](https://static.pepy.tech/badge/grouprec)](https://pepy.tech/project/grouprec)
[![Downloads/month](https://static.pepy.tech/badge/grouprec/month)](https://pepy.tech/project/grouprec)
...
```bash
pip install grouprec                  # light numpy/scipy core (works out of the box)
pip install grouprec[implicit]        # + implicit (ALS/BPR) backend
pip install grouprec[lenskit]         # + LensKit backend (ImplicitMF/ItemKNN/EASE/SLIM/…)
pip install grouprec[recbole]         # + RecBole backend (experimental)
pip install grouprec[torch]           # + deep group models (AGREE/GroupIM/ConsRec/…)
...
**Licensing:** the library is **MIT** (the *code*); datasets keep their own licenses.
No conflict, because **we never redistribute data** — it's fetched from the canonical
host onto your machine, and anything non-redistributable is `manual`. Plus
...
- **Aggregators** (numpy core): `ADD AVG LMS MUL MPL AVGNM BDC FAI`,
  ...
  EPFuzzDAWeighted SDAA SIAA` (sequential) — each validated against its paper.
...
**link your repo/paper** in a `port-request` issue and we'll port it. Every method
