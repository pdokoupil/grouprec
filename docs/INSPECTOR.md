...
self-contained page generated by [`scripts/build_inspector.py`](../scripts/build_inspector.py).
...
Everything above is computed **once, offline**, by `build_inspector.py`, then **baked into a
